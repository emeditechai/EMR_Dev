...
public class LabInvestigationListItem
{
    ...
    public bool OVD_Document { get; set; }
...
public class LabInvestigationCreateRequest
{
...
public class LabInvestigationUpdateRequest
{
    public int Test_ID { get; set; }
    public int Department_ID { get; set; }
    public int Category_ID { get; set; }
...
public class LabInvestigationToggleStatusRequest
{
    public int Test_ID { get; set; }
    public bool Status { get; set; }
    public int? UserId { get; set; }
