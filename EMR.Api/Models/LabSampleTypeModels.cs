...
public class LabSampleTypeListItem
{
...
public class LabSampleTypeCreateRequest
{
    public string Sample_Name { get; set; } = string.Empty;
...
public class LabSampleTypeUpdateRequest
{
    public int Sample_Type_ID { get; set; }
    public string Sample_Name { get; set; } = string.Empty;
    public ContainerTypeEnum Container_Type { get; set; }
...
public class LabSampleTypeToggleStatusRequest
{
    public int Sample_Type_ID { get; set; }
    public bool Status { get; set; }
    public int? UserId { get; set; }
