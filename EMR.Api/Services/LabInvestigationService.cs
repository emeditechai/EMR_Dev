...
public class LabInvestigationService(IDbConnectionFactory db) : ILabInvestigationService
{
    ...
    public async Task<int> CreateAsync(LabInvestigationCreateRequest req)
    {
        ...
        p.Add("@Applicable_Gender", req.Applicable_Gender);
        p.Add("@Is_Billable", req.Is_Billable);
        p.Add("@Age_Operator", req.Age_Operator);
        p.Add("@Applicable_Age", req.Applicable_Age);
        p.Add("@Is_Fasting_Required", req.Is_Fasting_Required);
        p.Add("@Sample_Quantity", req.Sample_Quantity);
        p.Add("@Sample_Quantity_Unit_ID", req.Sample_Quantity_Unit_ID);
