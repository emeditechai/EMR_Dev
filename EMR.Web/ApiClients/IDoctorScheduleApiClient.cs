...
namespace EMR.Web.ApiClients
{
    ...
    {
        Task<List<DoctorScheduleListItem>> GetByDoctorAsync(int doctorId, int? branchId = null);
        ...
        Task<List<DoctorScheduleExceptionListItem>> GetExceptionsAsync(int doctorId, int? branchId = null, DateTime? from = null, DateTime? to = null);
