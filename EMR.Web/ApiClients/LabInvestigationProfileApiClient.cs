...
public class LabInvestigationProfileApiClient(IHttpClientFactory factory) : ILabInvestigationProfileApiClient
{
    ...
    public async Task<IEnumerable<LabInvestigationProfileHeaderModel>> GetListAsync(int? branchId = null, string? profileType = null, bool? status = null, string? search = null, int? companyId = null)
    {
