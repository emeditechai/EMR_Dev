...
public class LabTestMethodApiClient(IHttpClientFactory factory) : ILabTestMethodApiClient
{
    ...
    public async Task<IEnumerable<LabTestMethodModel>> GetListAsync(int? branchId = null, int? departmentId = null, bool? status = null, string? search = null, int? companyId = null)
    {
