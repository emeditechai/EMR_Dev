...
public class LabTestSubCategoryApiClient(IHttpClientFactory factory) : ILabTestSubCategoryApiClient
{
    ...
    public async Task<IEnumerable<LabTestSubCategoryModel>> GetListAsync(int? branchId = null, int? categoryId = null, bool? status = null, string? search = null, int? companyId = null)
    {
