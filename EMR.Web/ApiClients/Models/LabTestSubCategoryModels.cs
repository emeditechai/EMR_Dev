...
public class LabTestSubCategoryModel
{
...
public class LabTestSubCategoryCreateRequestModel
{
    public int Category_ID { get; set; }
    public string SubCategory_Name { get; set; } = string.Empty;
    public int Display_Order { get; set; } = 1;
...
public class LabTestSubCategoryUpdateRequestModel
{
    public int SubCategory_ID { get; set; }
    public int Category_ID { get; set; }
    public string SubCategory_Name { get; set; } = string.Empty;
...
public class LabTestSubCategoryToggleStatusRequestModel
{
    public int SubCategory_ID { get; set; }
    public bool Status { get; set; }
    public int? UserId { get; set; }
