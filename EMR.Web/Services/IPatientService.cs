...
public interface IPatientService
{
    ...
    Task<IEnumerable<(int DoctorId, string FullName, int? PrimarySpecialityId, string Gender)>> GetOpdDoctorsAsync(int? branchId, int? departmentId = null, int? specialityId = null);
