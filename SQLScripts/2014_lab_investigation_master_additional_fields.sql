-- ====================================================================================================
-- Script: 2014_lab_investigation_master_additional_fields.sql
-- Description: Adds Is_Fasting_Required, Sample_Quantity, Sample_Quantity_Unit_ID, 
--              Reported_Duration_Value, and Reported_Duration_Unit to dbo.LabInvestigationMaster.
...
PRINT 'Adding additional columns to dbo.LabInvestigationMaster...';

-- 1. Is_Fasting_Required
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.LabInvestigationMaster') AND name = 'Is_Fasting_Required')
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Is_Fasting_Required BIT NOT NULL DEFAULT 0;
    PRINT 'Added Is_Fasting_Required column to dbo.LabInvestigationMaster';
END

-- 2. Sample_Quantity
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.LabInvestigationMaster') AND name = 'Sample_Quantity')
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Sample_Quantity DECIMAL(18,2) NULL;
    PRINT 'Added Sample_Quantity column to dbo.LabInvestigationMaster';
END

-- 3. Sample_Quantity_Unit_ID
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.LabInvestigationMaster') AND name = 'Sample_Quantity_Unit_ID')
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Sample_Quantity_Unit_ID INT NULL;
    ALTER TABLE dbo.LabInvestigationMaster ADD CONSTRAINT FK_LabInvestigationMaster_SampleQuantityUnit 
        FOREIGN KEY (Sample_Quantity_Unit_ID) REFERENCES dbo.LabUnitMaster(Unit_ID);
    PRINT 'Added Sample_Quantity_Unit_ID column and foreign key to dbo.LabInvestigationMaster';
END

-- 4. Reported_Duration_Value
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.LabInvestigationMaster') AND name = 'Reported_Duration_Value')
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Reported_Duration_Value INT NULL;
    PRINT 'Added Reported_Duration_Value column to dbo.LabInvestigationMaster';
END

-- 5. Reported_Duration_Unit
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo.LabInvestigationMaster') AND name = 'Reported_Duration_Unit')
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Reported_Duration_Unit VARCHAR(20) NULL DEFAULT('Days');
    PRINT 'Added Reported_Duration_Unit column to dbo.LabInvestigationMaster';
END
...
BEGIN
    ...
    (
        ...
        Reported_Duration_Value, Reported_Duration_Unit, MRP, Status, CreatedBy, CreatedDate
    )
    VALUES
    (
        ...
        ISNULL(@Is_Fasting_Required,0), @Sample_Quantity, @Sample_Quantity_Unit_ID,
        @Reported_Duration_Value, ISNULL(@Reported_Duration_Unit,'Days'),
...
PRINT 'Script 2014_lab_investigation_master_additional_fields.sql executed successfully.';
GO
