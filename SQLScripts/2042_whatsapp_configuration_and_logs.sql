...
BEGIN
    CREATE TABLE dbo.WhatsAppConfiguration (
        ...
        VideoNotificationEnabled    BIT NOT NULL DEFAULT 1,
        VideoPatientMessageTemplate NVARCHAR(1000) NOT NULL DEFAULT 'Dear {PatientName}, your Video Consultation with Dr. {DoctorName} on {Date} at {Time} is confirmed. Join using: {Link}',
        VideoDoctorMessageTemplate  NVARCHAR(1000) NOT NULL DEFAULT 'Dear Dr. {DoctorName}, you have a Video Consultation scheduled with {PatientName} on {Date} at {Time}. Start using: {Link}',
...
BEGIN
    INSERT INTO dbo.WhatsAppConfiguration (
        ...
        VideoPatientMessageTemplate,
        VideoDoctorMessageTemplate,
        IsDefault,
        IsActive,
        CreatedBy,
        CreatedDate
        ...
        1,
        'Dear {PatientName}, your Video Consultation with Dr. {DoctorName} on {Date} at {Time} is confirmed. Join using: {Link}',
        'Dear Dr. {DoctorName}, you have a Video Consultation scheduled with {PatientName} on {Date} at {Time}. Start using: {Link}',
        1,
        1,
        'System Seed',
        GETDATE()
