-- ============================================================
-- Script: 2070_add_special_remarks_to_lab_reference_range.sql
-- Description: Adds Special_Remarks column to dbo.LabReferenceRangeMaster and updates SPs
-- ============================================================
...
-- 1. Add Special_Remarks column if not exists
IF NOT EXISTS (
    SELECT 1 
    FROM sys.columns 
    WHERE object_id = OBJECT_ID('dbo.LabReferenceRangeMaster') 
      AND name = 'Special_Remarks'
)
BEGIN
    ALTER TABLE dbo.LabReferenceRangeMaster
    ADD Special_Remarks NVARCHAR(1000) NULL;
END
GO
