...
BEGIN
    ALTER TABLE dbo.LabInvestigationMaster ADD Prescription_Required BIT NOT NULL DEFAULT 0;
    PRINT 'Added Prescription_Required column';
END
GO
...
PRINT 'Script 2129_investigation_opd_doc_prescription_required.sql executed successfully.';
GO
