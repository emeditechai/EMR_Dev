...
IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'X-Ray' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('X-Ray', @RadiologyCatId, 1, 1, GETDATE());

IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'CT Scan' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('CT Scan', @RadiologyCatId, 1, 1, GETDATE());

IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'MRI' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('MRI', @RadiologyCatId, 1, 1, GETDATE());

IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'USG' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('USG', @RadiologyCatId, 1, 1, GETDATE());

IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'Mammography' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('Mammography', @RadiologyCatId, 1, 1, GETDATE());

IF NOT EXISTS (SELECT 1 FROM LabTestSubCategoryMaster WHERE SubCategory_Name = 'Doppler' AND Category_ID = @RadiologyCatId)
    INSERT INTO LabTestSubCategoryMaster (SubCategory_Name, Category_ID, CompanyId, Status, CreatedDate) VALUES ('Doppler', @RadiologyCatId, 1, 1, GETDATE());
GO
...
IF NOT EXISTS (SELECT 1 FROM LabInvestigationMaster WHERE Test_Code = 'RAD-XR-001')
    INSERT INTO LabInvestigationMaster (Test_Code, Test_Name, Department_ID, Category_ID, SubCategory_ID, Reporting_Type, TAT_Hours, Is_Billable, Status, CompanyId, CreatedDate)
...
IF NOT EXISTS (SELECT 1 FROM LabInvestigationMaster WHERE Test_Code = 'RAD-CT-001')
    INSERT INTO LabInvestigationMaster (Test_Code, Test_Name, Department_ID, Category_ID, SubCategory_ID, Reporting_Type, TAT_Hours, Is_Billable, Is_Consent_Required, Status, CompanyId, CreatedDate)
